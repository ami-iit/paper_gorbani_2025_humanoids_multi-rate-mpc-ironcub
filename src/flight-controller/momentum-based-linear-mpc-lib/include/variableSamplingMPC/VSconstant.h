...
constexpr std::array<int, N_THRUSTS> thrustIdx = {12, 13, 14, 15};
constexpr std::array<int, N_THRUSTS> thrustDotIdx = {16, 17, 18, 19};
constexpr std::array<int, 3> positionErrorIdx = {20, 21, 22};
constexpr std::array<int, 3> rpyErrorIdx = {23, 24, 25};
