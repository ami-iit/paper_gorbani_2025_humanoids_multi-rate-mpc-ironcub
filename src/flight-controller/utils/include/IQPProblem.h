...
public:
    ...
    /**
     * @brief Set the Scaling matrix of the QP problem.
     *
     * @param scalingVector
     */
    void useScaling(const Eigen::VectorXd& scalingVector);
...
private:
    ...
    Eigen::MatrixXd m_scalingMatrix; /**< The scaling matrix of the QP problem. */
    Eigen::MatrixXd m_hessianScaled; /**< The Hessian matrix of the QP problem. */
    Eigen::VectorXd m_gradientScaled; /**< The gradient vector of the QP problem. */
    Eigen::MatrixXd m_linearMatrixScaled; /**< The constraint matrix of the QP problem. */
    Eigen::VectorXd m_outputQPScaled; /**< The solution of the QP problem. */
    Eigen::SparseMatrix<double> m_hessianSparseScaled; /**< The Hessian matrix of the QP problem
                                                (sparse version). */
    Eigen::SparseMatrix<double> m_linearMatrixSparseScaled; /**< The constraint matrix of the QP
                                                         problem (sparse version). */
};

#endif /* end of include guard IQPROBLEM_H */
